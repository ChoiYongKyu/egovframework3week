...
<div class="card card-plain">
	<form action="insertModify" method="post" name="fm">
		<input type="hidden" value="${modify.BUGREPORT_NO }" name="bugreport_no"/>
		<div class="content">
			<div class="row">
					...
					<div class="content">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea cols="10" name="bugreport_problem" class="form-control border-input">${modify.BUGREPORT_PROBLEM }</textarea>
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea cols="10" rows="17" name="bugreport_answer" class="form-control border-input">${modify.BUGREPORT_ANSWER }</textarea>
							</div>
						</div>
						<div class="col-lg-12">
