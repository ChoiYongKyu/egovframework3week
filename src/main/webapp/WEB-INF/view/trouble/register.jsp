...
<div class="card card-plain">
	<div class="content">
		<div class="row">
			<form action="insertTrouble" method="post" name="fm">
					...
					<div class="content">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea cols="10" name="trouble_problem" class="form-control border-input"></textarea>
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea cols="10" rows="17" name="trouble_answer" class="form-control border-input"></textarea>
							</div>
						</div>
						<div class="col-lg-12">
