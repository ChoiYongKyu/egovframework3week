...
public class TroubleServiceImpl implements TroubleService {
	...
	private final static Logger logger = Logger.getLogger(TroubleServiceImpl.class);
	...
	public void insert(Map<String, Object> value) {
		mapper.insert(value);
		value.put("board_category", "trouble");
	...
	public Map<String, Object> getModify(int no) {
		logger.debug(mapper.getModify(no));
